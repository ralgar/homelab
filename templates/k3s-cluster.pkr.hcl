source "proxmox-clone" "k3s-master" {
  ...
  full_clone           = false
  vm_name              = "template-k3s-master"
  vm_id                = 9998
  template_name        = "template-k3s-master"
  template_description = <<-EOT
    K3s Master Control-Plane Node template (Rocky Linux 8).
...
source "proxmox-clone" "k3s-controller" {
  ...
  clone_vm             = "template-rocky8"
  full_clone           = false
  vm_name              = "template-k3s-controller"
  vm_id                = 9997
